...
if exists(select * from sysobjects where id = object_id('batch_rpttaxcredit_ledger'))
begin
  drop table batch_rpttaxcredit_ledger
end 
go
if exists(select * from sysobjects where id = object_id('batch_rpttaxcredit'))
begin
  drop table batch_rpttaxcredit
end 
go
...
delete from sys_usergroup where objid like 'RPT.CERTIFICATION_%'
go 
...
go 
alter table batchgr add CONSTRAINT batchgr_ibfk_1 
  FOREIGN KEY (barangay_objid) REFERENCES sys_org (objid)
go 
alter table batchgr add CONSTRAINT batchgr_ibfk_2 
  FOREIGN KEY (classification_objid) REFERENCES propertyclassification (objid)
go 
alter table batchgr add CONSTRAINT batchgr_ibfk_3 
  FOREIGN KEY (lgu_objid) REFERENCES sys_org (objid)
go 
alter table batchgr add CONSTRAINT batchgr_ibfk_4 
  FOREIGN KEY (barangay_objid) REFERENCES sys_org (objid)
go 
alter table batchgr add CONSTRAINT batchgr_ibfk_5 
  FOREIGN KEY (classification_objid) REFERENCES propertyclassification (objid)
go 
alter table batchgr add CONSTRAINT batchgr_ibfk_6 
  FOREIGN KEY (lgu_objid) REFERENCES sys_org (objid)
go 
...
alter table batchgr_task add CONSTRAINT batchgr_task_ibfk_1 FOREIGN KEY (refid) REFERENCES batchgr (objid)
go 
...
go 
alter table batchgr_item add CONSTRAINT batchgr_item_ibfk_5 FOREIGN KEY (objid) REFERENCES faas (objid)
go 
